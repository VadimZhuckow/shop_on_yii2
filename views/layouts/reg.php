                    ...
                    <div class="cardify login">
                        ...
                        <div class="login--form">
                            <div class="form-group">
                                ...
                                <input id="user_name" name="login" type="email" class="text_field" placeholder="Enter your username...">
                            </div>
                            <div class="form-group">
                            ...
                            <button class="btn btn--md btn-primary" type="submit">Зарегистрироваться</button>
        ...
        $('#register').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res == 'login_no_email'){
                        $('.err').text('Введенный логин не является почтой');
                    }
                    if (res == 'user_already_exists'){
                        $('.err').text('Такой пользователь уже существует');
                    }
                    if (res == 1){
